...
<div class="container">
    <?php
    $tampil=$mysqli->query("SELECT * FROM berita INNER JOIN user ON berita.id_user = user.id INNER JOIN kategori ON berita.id_kategori = kategori.id ORDER BY berita.id_berita DESC");
    $no=1;
    ?>
